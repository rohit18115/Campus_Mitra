...
public class SelectCoursesRecyclerViewAdaptor extends RecyclerView.Adapter<SelectCoursesRecyclerViewAdaptor.ViewHolder> implements Filterable {
    private static final String TAG = "SelectCoursesRecyclerViewAdaptor";

    private List<CourseSelectModel> mModelList;
    private List<CourseSelectModel> mModelListFull;
    private Context mContext;

    public SelectCoursesRecyclerViewAdaptor(List<CourseSelectModel> mModelList,Context mcontext ) {
    ...
    private Filter courseFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<CourseSelectModel> filteredList = new ArrayList<>();
